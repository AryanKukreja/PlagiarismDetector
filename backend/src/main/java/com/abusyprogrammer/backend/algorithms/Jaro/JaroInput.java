...
/**
 * The JaroInput class is used to structure the body of incoming requests
 * to the JaroController.
 * 
 * @author Aryan Kukreja
 * @version 1.0.0
 * @since 2021-08-19
 */
public class JaroInput {
	 ...
	 */
	public JaroInput(String text1, String text2) {
		this.text1 = text1;
		this.text2 = text2;
	}
